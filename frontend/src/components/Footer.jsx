        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                href="https://github.com/harshdeepKhartade10"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/harshdeep-khartade-10hkk/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  href="https://pastebin-lite-backend-6uu2.onrender.com/api/healthz"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors"
                >
